...
export function DashboardPage() {
  ...
  return <section className="space-y-8"><div><p className="eyebrow">Welcome back</p><h1 className="page-title">Dashboard</h1><p className="page-description">A clear view of the catalogue before its next release.</p></div>
    ...
    <section className="quick-actions"><h2>Quick actions</h2><div><Button asChild><Link to="/admin/shows/new">Add Show</Link></Button><Button asChild variant="accent"><Link to="/admin/episodes/new">Add Episode</Link></Button><Button asChild variant="outline"><Link to="/admin/publish">Publish Catalogue</Link></Button><Button asChild variant="outline"><Link to="/admin/seed-preflight">Seed Preflight</Link></Button></div></section>
  </section>
}
