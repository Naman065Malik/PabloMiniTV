export default function Hero() {
  return (
    <section className="min-h-[420px] max-h-[440px] rounded-[28px] bg-[#ded3fb] flex items-stretch overflow-hidden relative mt-[14px]" id="top">
      <div className="w-[45%] p-[58px_16px_50px_56px] relative z-10 flex flex-col justify-center">
        ...
        <button className="button-yellow inline-flex items-center justify-center rounded-full px-7 py-3.5 text-base font-black transition-all hover:-translate-y-0.5 hover:shadow-[0_8px_16px_#4323a329]">▶ &nbsp; Start Watching</button>
      </div>
