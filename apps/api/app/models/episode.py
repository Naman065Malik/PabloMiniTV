...
class Episode(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("duration_seconds IS NULL OR duration_seconds > 0", name="ck_episodes_duration_positive"),
    ...
    status: Mapped[EpisodeStatus] = mapped_column(Enum(EpisodeStatus), default=EpisodeStatus.DRAFT, nullable=False, index=True)
